...
TEST_CASE("Character Distance Calculation") 
{
    Point loc1(1, 2);
...
TEST_CASE("Cowboy constructor (dynamic memory allocation)") 
{
    Point loc(10, 20);
...
TEST_CASE("Cowboy Cartridge Has Bullets") 
{
    Point loc(10, 20);
...
TEST_CASE("OldNinja constructor (dynamic memory allocation)") 
{
    Point loc(10, 20);
...
TEST_CASE("TrainedNinja constructor (dynamic memory allocation)") 
{
    Point loc(10, 20);
...
TEST_CASE("YoungNinja constructor (dynamic memory allocation)") 
{
    Point loc(10, 20);
...
TEST_CASE("OldNinja slashing Cowboy(1).") 
{
    Point loc1(10, 20);
...
TEST_CASE("OldNinja slashing Cowboy(2).") 
{
    Point loc1(10, 20);
